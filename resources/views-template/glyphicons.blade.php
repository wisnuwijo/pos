...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/custom_css/glyphicons.css')}}">
...
<script type="text/javascript" src="{{asset('assets/js/custom_js/glyphicons.js')}}"></script>
