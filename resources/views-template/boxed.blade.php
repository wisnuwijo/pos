    ...
    <nav class="navbar navbar-expand-md navbar-static-top" role="navigation">
        ...
        <div class="navbar-right ml-auto" id="navbarNav">
            <ul class="nav navbar-nav">
                ...
                <!--tasks-->
                <li class="dropdown tasks-menu d-none d-md-block nav-item">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="calendar ">
                                    <i class=" menu-icon fa fa-fw fa-calendar"></i>
                                    <span>Calendar</span>
                                    <small class="badge badge-pill badge-success float-right mt-1">7</small>
                                </a>
                            </li>
                            <li>
                                <a href="calendar2 ">
                                    ...
                                    <small class="badge badge-pill badge-success float-right mt-1">6</small>
                                </a>
                            </li>
                        </ul>
                    </li>
