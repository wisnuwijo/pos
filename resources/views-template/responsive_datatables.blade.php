...
@section('content')
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card border-success filterable">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered"  cellspacing="0" id="table3">
                                    <thead>
                                    <tr>
                                        <th>First Name</th>
                                        <th>Last Name</th>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card border-danger filterable">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" cellspacing="0" id="table4">
                                    <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>First Name</th>
                    ...
                    <div class="card border-success filterable">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" cellspacing="0" id="table5">
                                    <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Position</th>
