                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>Larson</td>
                                    <td>Industrial</td>
                                    <td><span class="label label-sm bg-success">Approved</span></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Vincenzo</td>
                                    <td>Bashirian</td>
                                    <td>Baby</td>
                                    <td><span class="label label-sm bg-danger">Blocked</span></td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Winona</td>
                                ...
                                <tr>
                                    ...
                                    <td>Labadie</td>
                                    <td>Music</td>
                                    <td><span class="label label-sm bg-warning">Suspended</span></td>
                                </tr>
                                <tr>
                                    <td>6</td>
                                    <td>Jackson</td>
