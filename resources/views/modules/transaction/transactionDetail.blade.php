                    ...
                    <div class="card-body">
                        <div class="form-body px-3">
                            <div class="form-group m-t-10 row">
                                ...
                                <input type="text" class="form-control" value="{{ $transaction->customer_name }}" readonly>
                            </div>
                            <div class="form-group m-t-10 row">
                                <label for="date" class="col-form-label text-lg-right text-left">
                                    Tanggal
                                </label>
                                <input type="datetime" class="form-control"  value="{{ formatDate($transaction->created_at) }}" readonly>
                            </div>
                            <div class="form-group m-t-10 row">
                                <label for="grandTotal" class="col-form-label text-lg-right text-left">
                                    Grand total
                                </label>
                                <input type="text" class="form-control"  value="Rp. {{ formatNumber($transaction->grand_total) }}"  readonly>
                            </div>
                            <div class="form-group m-t-10 row">
                                <label for="voucherSelect" class="col-form-label text-lg-right text-left">
                                    Voucher
                                </label>
                                <input type="text" class="form-control"  value="{{ $transaction->voucher_name }}"  readonly>
                            </div>
                            <div class="form-group m-t-10 row">
                            ...
                            @foreach ($detail_transaction as $dtrx)
                                <div class="form-group m-t-10 row">
                                    <div class="col-xs-1">
                                        <span class="btn btn-default">{{ $trxNum++ }}.</span>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="goodsSelect" class="col-form-label text-lg-right text-left">
                                            Pesanan
                                        </label>
                                        <input type="text" class="form-control"  value="{{ $dtrx->goods_name }}" readonly>
                                    </div>
                                    <div class="col-md-2">
                                        <label for="qty" class="col-form-label text-lg-right text-left">
                                            Jumlah pesanan
                                        </label>
                                        <input type="text" class="form-control"  value="{{ $dtrx->qty }}" readonly>
                                    </div>
                                    <div class="col-md-2">
                                        <label class="col-form-label text-lg-right text-left">
                                            Harga satuan
                                        </label>
                                        <input type="text" class="form-control"  value="{{ formatNumber($dtrx->goods_price) }}" readonly>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="row">
                                            <div class="col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <?php
                                                    $discountNumber = '0';
                                                    if ($dtrx->goods_discount_percent > 0) {
                                                        $discountNumber = $dtrx->goods_discount_percent.'%';
                                                    } else if ($dtrx->goods_discount_amount > 0){
                                                        $discountNumber = 'Rp. '.$dtrx->goods_discount_amount;
                                                    }
                                                ?>
                                                <input type="text" class="form-control"  value="{{ $discountNumber }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control"  value="Rp. {{ formatNumber($dtrx->goods_price_after_discount) }}"  readonly>
                                    </div>
                                </div>
                            @endforeach
                        </div>
